...
<div class="relative" style="height: 100vh; width: 100vw;">
    ...
    <div id="sidebar" class="absolute top-0 left-0 w-64 h-full bg-white border-r overflow-auto transform -translate-x-full transition-transform duration-300 ease-in-out z-20">
